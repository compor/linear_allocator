...
class test_linear_private_allocator : public testing::Test {
 public:
  test_linear_private_allocator() {}
...
TEST_F(test_linear_private_allocator, vector_allocation_basic) {
  using alloc_t = int;
...
TEST_F(test_linear_private_allocator, list_allocation_basic) {
  using alloc_t = int;
...
TEST_F(test_linear_private_allocator, vector_allocation_misalignment) {
  using alloc_t = int;
...
TEST_F(test_linear_private_allocator,
