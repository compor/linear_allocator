...
TEST_F(test_linear_shared_allocator, vector_allocation_basic) {
  ...
  using lpa_t = mneme::linear_shared_allocator<alloc_t, 150>;
...
TEST_F(test_linear_shared_allocator, list_allocation_basic) {
  ...
  using lpa_t = mneme::linear_shared_allocator<alloc_t, 450>;
...
TEST_F(test_linear_shared_allocator,
  ...
  using lpa_t = mneme::linear_shared_allocator<alloc_t, 300>;
...
//TEST_F(
  ...
  //using lpa1_t = mneme::linear_shared_allocator<alloc_t, 300>;
  //using lpa2_t = mneme::linear_shared_allocator<alloc_t, 400>;
